...
Status: DONE (executor completed; candidate for independent QA; surgically repaired fail-closed teardown semantics; cancellation or verification failure preserves non-DISPOSED lifecycle state without swallowing exceptions; 46 unit and closure tests passing; implemented in src/basebreak/adapters/nebius/sandbox.py)
